...
public class Controller implements Initializable {
    ...
    public void editStudent(ActionEvent actionEvent) {
        try{
            ...
            mutipageS.list.Controller.editStudent.setBirth(LocalDate.parse(txtBirth.getText().toString()));
            mutipageS.list.Controller.editStudent.setMark(Double.valueOf(txtMark.getText().toString()));
            goToList();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        try{
            if(mutipageS.list.Controller.editStudent==null){
                goToList();
            }

            txtBirth.setText(String.valueOf(mutipageS.list.Controller.editStudent.getBirth()));
            txtMark.setText(String.valueOf(mutipageS.list.Controller.editStudent.getMark()));
            txtName.setText(mutipageS.list.Controller.editStudent.getName());
            txtCode.setText(mutipageS.list.Controller.editStudent.getCode());
